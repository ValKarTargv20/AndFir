...
namespace AndFir
{
    ...
    public partial class ListV_Page : ContentPage
    {
        ...
        public ListV_Page()
        {
            ...
            {
                new Telefon {Nimetus="Galaxy S22 Ultra", Tootja="Samsung", Hind=1349, Pilt="GalaxyS22.jpg"},
                new Telefon {Nimetus="Mi 11 Lite 5G NE", Tootja="Xiaomi", Hind=399, Pilt = "Xiaomi5GNE.jpg"},
                new Telefon {Nimetus="Mi 11 Lite 5G", Tootja="Xiaomi", Hind=399, Pilt = "XiaomiMiLite.jpg"},
